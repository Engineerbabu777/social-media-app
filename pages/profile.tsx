...
export default function Page() {
    ...
    let active = 'flex gap-1 items-center border-b-4 px-3 font-bold text-blue-500 border-blue-500 py-1 cursor-pointer';
        ...
        <Card noPadding>
            <div className="relative">
                ...
                <div className="flex gap-5 mt-10 ml-2">
                    <p  className={curr === 'posts' ? active:unactive} onClick={() => setCurr('posts')}>
                        {/* ICON!! */}
                    ...
                    <p className={curr === 'about' ? active:unactive} onClick={() => setCurr('about')}>
                        {/* ICON!! */}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <p className={curr === 'friends' ? active:unactive} onClick={() => setCurr('friends')}>
                        {/* ICON!! */}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <p className={curr === 'photos' ? active:unactive} onClick={() => setCurr('photos')}>
                        {/* ICON!! */}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            {curr==='about' && <Card>
              <div className="">
                ...
                <p className="text-sm mb-2">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using making it look like readable English.</p>
                <p className="text-sm mb-2">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using making it look like readable English.</p>
              </div>
